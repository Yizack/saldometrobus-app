...
export default {
  ...
  about_message: "\"Metrobus Balance\" is an app for checking balances and transactions for the metro and metrobús cards in Panama, designed and developed by Yizack Rangel. This app is NOT official, is not owned or endorsed by any government affiliation.",
  ...
  location: "Location",
  destino: "Destination",
  intercambiar_direcciones: "Swap origin and destination",
  ...
  rate: "Rate app",
  limit_title: "Notice: Card info reading limit",
